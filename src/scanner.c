...
**
*A  @(#)$Id: scanner.c,v 1.1.1.1 1996/12/11 12:43:59 werner Exp $
**
...
void            GetInt ()
{
    ...
    if ( sizeof(Value)-1 <= i )
        SyntaxError("integer must have less than " MAXVALUE " digits");
...
void            GetStr ()
{
    ...
    if ( sizeof(Value)-1 <= i )
        SyntaxError("string must have less than " MAXVALUE " characters");
...
void            InitScanner ()
{
    ...
    Output = OutputFiles-1;  OpenOutput( "*stdout*" );/* error code ignored */
