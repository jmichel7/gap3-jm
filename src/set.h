...
**
*H  @(#)$Id: set.h,v 1.1.1.1 1996/12/11 12:43:59 werner Exp $
**
...
**
*H  $Log: set.h,v $
*H  Revision 1.1.1.1  1996/12/11 12:43:59  werner
...
*/
extern  TypHandle       ElmSet (
            TypHandle           hdList,
            long                pos );

extern  TypHandle       ElmfSet (
            TypHandle           hdList,
            long                pos );
...
*/
extern  TypHandle       FunIsEqualSet (
            TypHandle           hdCall );
...
*/
extern  TypHandle       FunIsSubsetSet (
            TypHandle           hdCall );
...
*/
extern  TypHandle       FunIntersectSet (
            TypHandle           hdCall );
...
*/
extern  TypHandle       FunSubtractSet (
            TypHandle           hdCall );
