...
**
*H  @(#)$Id: vecffe.h,v 1.1.1.1 1996/12/11 12:44:01 werner Exp $
**
...
*H
*H  Revision 3.2  1994/01/28  12:49:24  fceller
*H  added 'DepthVecFFE'
*H
...
**  vectors.
*/
extern  TypHandle       ElmVecFFE (
            TypHandle           hdList,
            long                pos );

extern  TypHandle       ElmfVecFFE (
            TypHandle           hdList,
            long                pos );

extern  TypHandle       ElmlVecFFE (
            TypHandle           hdList,
            long                pos );

extern  TypHandle       ElmrVecFFE (
            TypHandle           hdList,
            long                pos );
...
**  call 'SUM'.
*/
extern  TypHandle       SumVecFFEVecFFE (
            TypHandle           hdL,
            TypHandle           hdR );
...
**  call 'DIFF'.
*/
extern  TypHandle       DiffFFEVecFFE (
            TypHandle           hdL,
            TypHandle           hdR );
...
**  call 'DIFF'.
*/
extern  TypHandle       DiffVecFFEFFE (
            TypHandle           hdL,
            TypHandle           hdR );
...
**  not call 'PROD'.
*/
extern  TypHandle       DiffVecFFEVecFFE (
            TypHandle           hdL,
            TypHandle           hdR );
...
**  call 'PROD'.
*/
extern  TypHandle       ProdFFEVecFFE (
            TypHandle           hdL,
            TypHandle           hdR );
...
**  call 'PROD'.
*/
extern  TypHandle       ProdVecFFEFFE (
            TypHandle           hdL,
            TypHandle           hdR );
...
**  not call 'PROD'.
*/
extern  TypHandle       ProdVecFFEVecFFE (
            TypHandle           hdL,
            TypHandle           hdR );
...
*/
extern  TypHandle       ProdVecFFEMatFFE (
            TypHandle           hdL,
            TypHandle           hdR );
...
**  'MakeVecFFE( <list>, <ffe> )'
*/
extern  TypHandle       FunMakeVecFFE (
            TypHandle           hdCall );
...
*/
extern  TypHandle       FunNumberVecFFE (
            TypHandle           hdCall );
...
*/
extern  TypHandle       FunDepthVector (
            TypHandle           hdCall );
