...
|   gap> Display(XTable(UnipotentClasses(W),rec(classes:=true)));
...
|   gap> t:=XTable(UnipotentClasses(CoxeterGroup("G",2)),rec(classes:=true));
...
|   gap> Display(GreenTable(UnipotentClasses(W),rec(classes:=true)));
