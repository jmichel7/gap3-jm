...
def ptio1(x,option):
  ...
  if "TeX" in option :
    ...
    s="phi"
  s.extend(SPrint("{",x[1-1],",",x[2-1],"}"))
  if len(x)==3 :
    s.extend(map(lambda y: '\'',range(1,x[3-1]+1)))
  return just(s)

ChevieData["IndirectAddData"]("CharName",["2E6","E6","E7","E8","2F4","F4","G2","H3","H4","2G5","G24","G25","G26","G27","G29","G31","G32","G33","G34"],lambda t: ptio1)
...
ChevieData["IndirectAddData"]("CartanMat",["G25","G26","G29","G31","G32","G34"],ptio2)
...
ChevieData["IndirectAddData"]("ReflectionName",["G24","G25","G26","G27","G29","G31","G32","G33","G34","E6","E7","E8","2E6","2F4","3D4","H3","H4"],lambda t: ptio3)
...
ChevieData["IndirectAddData"]("ReflectionName",["A","D","2A","2D"],lambda t: ptio4)
...
ChevieData["IndirectAddData"]("CharTable",["3D4","E6","2E6","E7","E8","F4","2F4","G2","H3","H4"],lambda t: ptio5)

def ptio6(q):
  return prod(ChevieData["t"]["ReflectionDegrees"])

ChevieData["IndirectAddData"]("PoincarePolynomial",["G24","G27","G29","G33","G34","H3","H4","E6","E7","E8"],lambda t: ptio6)
...
ChevieData["IndirectAddData"]("Representation",["G24","G25","G26","G27","G29"],lambda t: ptio7)
...
ChevieData["IndirectAddData"]("SemisimpleRank",["G2","F4","H3","E6","G24","G25","G26","G27","G29","G31","G32","G33","G34"],ptio8)
...
ChevieData["IndirectAddData"]("FakeDegree",["G2","F4","H3","E6","G24","G25","G26","G27","G29","G32","G33","G34"],lambda t: ptio9)
...
ChevieData["IndirectAddData"]("FakeDegree",["H4","E7","E8","G31"],lambda t: ptio10)

def ptio11():
  return map(ptio12,ChevieData["t"]["cycpolfakedegrees"])
...
ChevieData["IndirectAddData"]("HighestPowerFakeDegrees",["H4","E7","E8","G31"],lambda t: ptio11)

def ptio13():
  return map(lambda x: x[len(x)-1],ChevieData["t"]["sparseFakeDegrees"])

ChevieData["IndirectAddData"]("HighestPowerFakeDegrees",["E6","G32","G33","G34","G2","F4","H3","G24","G25","G26","G27","G29"],lambda t: ptio13)

def ptio14():
  return map(lambda x: x[2-1],ChevieData["t"]["sparseFakeDegrees"])

ChevieData["IndirectAddData"]("LowestPowerFakeDegrees",["G2","F4","H3","H4","G24","G25","G26","G27","G29","E6","E7","E8","G31","G32","G33","G34"],lambda t: ptio14)

def ptio15(indices,title):
  digits="678"
  print title," ",
...
ChevieData["IndirectAddData"]("PrintDiagram",["E6","E7","E8"],lambda t: ptio15)

def ptio16(indices,title):
  print title," ",
...
ChevieData["IndirectAddData"]("PrintDiagram",["H3","H4"],lambda t: ptio16)

def ptio17():
  N=Sum(ChevieData["t"]["ReflectionDegrees"],lambda x: x-1)
  return map(lambda x: N-Degree(CycPol(x)),ChevieData["t"]["CycPolSchurElements"])

ChevieData["IndirectAddData"]("HighestPowerGenericDegrees",["G24","G27","G29","G33","G34","H3","H4","E6","E7","E8"],lambda t: ptio17)

def ptio18():
  return map(lambda x: -x[2-1],ChevieData["t"]["CycPolSchurElements"])

ChevieData["IndirectAddData"]("LowestPowerGenericDegrees",["G24","G27","G29","G33","G34","H3","H4","E6","E7","E8"],lambda t: ptio18)
...
ChevieData["IndirectAddData"]("DecompositionMatrix",["F4","G2","G25","G26"],lambda t: ptio19)
...
ChevieData["IndirectAddData"]("SchurElement",["G24","G27","G29","G33","G34","E6","E7","E8","H3","H4"],lambda t: ptio20)
...
ChevieData["IndirectAddData"]("FactorizedSchurElement",["G24","G27","G29","G33","G34","E6","E7","E8","H3","H4"],lambda t: ptio21)
...
ChevieData["IndirectAddData"]("FactorizedSchurElement",["G2","F4","G25","G26","G32"],lambda t: ptio22)
...
ChevieData["IndirectAddData"]("SchurElement",["F4","G25","G26","G32"],lambda t: ptio23)
