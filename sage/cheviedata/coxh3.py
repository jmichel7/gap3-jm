...
def coxh31():
    a=GAPDiv(1+ER(5),2)
    return GAPDiv([[a,-1,GAPMin(a,1)],[-a,1,GAPMin(a,1)],[1,GAPMin(a,1),-a]],2)
...
ChevieData["H3"]["WGraphs"]=[[[[1,2,3]],[]],1,[[[2],[1,2],[1,3],[1,3],[2,3]],[[-1,[[1,3],[2,4],[3,5],[4,5]]]]],3,[[[1,2],[1,3],[2,3]],[[-1,[[1,2]]],[GAPDiv(GAPMin(-1,ER(5)),2),[[2,3]]]]],[[[1,2],[1,3],[2,3]],[[-1,[[1,2]]],[GAPDiv(-1+ER(5),2),[[2,3]]]]],5,6,[[[1],[2],[1,3],[2,3]],[[1,[[1,2,3],[2,3,4],[3,4]]]]],9]
...
def coxh314(a,b,c):
    return GAPMin(GAPMin(GAPMin(GAPMin(GAPMin(GAPMul(131835937500,a),GAPMul(100195312500,a**2))+GAPMul(395507812500,c**3),GAPMul(28369140625,a**3))+GAPMul(1371093750,a**4),GAPMul(74250000,a**7)),GAPMul(22233750,a**9))+GAPMul(438750,a**10),GAPMul(829,a**15))
