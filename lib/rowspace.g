...
##
#A  @(#)$Id: rowspace.g,v 1.3 1999/11/18 11:27:54 wdg Exp $
##
...
##
##  $Log: rowspace.g,v $
##  Revision 1.3  1999/11/18 11:27:54  wdg
##  change to rowspace.g (bug fixed by Thomas, sorry for committing it so late).
##
##  W
##
...
SemiEchelonBasisRowSpaceOps.SiftedVector := function( B, v )
    ...
    # Check whether the vector has the right dimension.
    if Length( v ) <> Length( B.ishead ) then
      return false;
    fi;
