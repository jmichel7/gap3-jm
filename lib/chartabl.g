...
#A                                                           & Goetz Pfeiffer
##
#A  @(#)$Id: chartabl.g,v 1.1.1.1 1996/12/11 12:37:55 werner Exp $
##
...
##
#H  $Log: chartabl.g,v $
#H  JM 2015/02/25 ported from chevie CharTableOps.CharNames
...
CharTableOps.CharNames:=function(t,option)local res,dims,a,letters,p,x,n;
  if IsBound(t.irredinfo) and IsBound(t.irredinfo[1].charname) then
    ...
    return List([1..Length(t.irreducibles)],i->SPrint("X.",i));
  fi;
end;
