...
##
#H  @(#)$Id: fpsgpres.g,v 1.5 1997/10/15 10:14:04 gap Exp $
##
...
##
#H  $Log: fpsgpres.g,v $
#H  Revision 1.5  1997/10/15 10:14:04  gap
#H  Fixes by TB and VF
#H
#H  Revision 1.3  1997/06/25 11:36:41  gap
#H  Fixes by V. Felsch. AH
#H
#H  Revision 1.2  1997/01/14 15:16:44  gap
#H  vfelsch introduced 'protected' to PresentationAugmentedCosetTable and
#H  reorganized how to get a presentation from an augmented coset table
#H
...
AugmentedCosetTableMtc := function ( G, H, ttype, string )
    ...
    for i in [ 1 .. numgens ] do
        genname := ConcatenationString( string, String( i ));
    ...
    for j in [1..index] do
        ...
        for i  in [ 1 .. numcols ]  do
            ...
            if gen[j] < 0  then
                ...
                od;
                numgens := numgens + 1;
                genname := ConcatenationString( string,String( numgens ));
