...
#A                                                              & Ansgar Kaup
##
#A  @(#)$Id: ctcharac.g,v 1.3 1998/02/27 10:22:36 gap Exp $
##
...
##
#H  $Log: ctcharac.g,v $
#H  Revision 1.3  1998/02/27 10:22:36  gap
#H  Various fixes by Thomas.
#H
#H  Revision 1.2  1997/01/20 09:24:15  gap
#H  fixed DANGEROUS bug in 'MolienSeries' (reported by Gregor Kemper)
#H
...
DecompositionMatrix := function( arg )
    ...
    else Error( "usage: DecompositionMatrix( <modmodtbl> [, <blocknr>])" );
    fi;
    elif Length(arg)>=1 and IsRec(arg[1]) and IsBound(arg[1].operations)
     and IsBound(arg[1].operations.DecompositionMatrix) then
      return ApplyFunc(arg[1].operations.DecompositionMatrix,arg);
    else Error(arg," has no method for DecompositionMatrix");
    fi;
    end;
