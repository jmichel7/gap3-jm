...
##
#H  @(#)$Id: fpgrp.g,v 1.9 1997/07/01 14:11:52 gap Exp $
##
...
##
#H  $Log: fpgrp.g,v $
#H  Revision 1.9  1997/07/01 14:11:52  gap
#H  Last fix does not need to issue an error but can refer to 'GHBIOps'. AH
#H
#H  Revision 1.8  1997/07/01 14:04:32  gap
#H  IsMapping for fp and ag groups: In GAP3 we cannot check whether in a
#H   mapping to an fp group relators of a preimage hold! We must issue an error. AH
#H
#H  Revision 1.7  1997/06/27 15:01:41  gap
#H  Bugfix Caranti. AH
#H
#H  Revision 1.6  1997/06/10 08:35:26  gap
#H  Fixed 'IsSubset' for fp groups. AH
#H
#H  Revision 1.5  1997/04/11 15:40:44  gap
#H  included martin's fix 29
#H
#H  Revision 1.4  1997/01/16 08:24:17  gap
#H  ahulpke disallowed RationalClasses for Fp groups
#H          fixed homomorphisms for free groups (that don't have relators)
#H  	removed a second 'l' in 'useful'
#H
#H  Revision 1.3  1997/01/15 17:25:23  gap
#H  fixed dangerous bug:
#H  trivial groups are elementary abelian by definition (e.g., in the manual);
#H      this was not true for f.p. groups.
#H
#H  Revision 1.2  1997/01/14 15:15:43  gap
#H  vfelsch fixed the parameters description of 'IsElementaryAbelian'
#H
#H  Revision 1.1.1.1  1996/12/11 12:37:50  werner
#H  Preparing 3.4.4 for release
#H
#H  Revision 3.38  1996/10/31 08:57:58  ahulpke
#H  *** empty log message ***
#H
#H  Revision 3.37  1996/09/12 13:52:04  mschoene
#H  fixed handling of abelian invariants
#H
#H  Revision 3.36  1996/09/12 09:40:27  vfelsch
#H  extended 'LowIndexSubgroupsFpGroup'
#H
#H  Revision 3.35  1996/09/11 10:57:58  mschoene
#H  fixed '.preimage' to '.preImage'
#H
#H  Revision 3.34  1995/11/25  15:51:34  mschoene
#H  cleaned up the handling of involutory generators
#H
#H  Revision 3.33  1995/11/23  11:11:12  mschoene
#H  fixed 'LowIndexSubgroups' for the case that a subgroup is given
#H
#H  Revision 3.32  1995/04/19  13:31:35  werner
#H  fixed AbelianInvariants() to handle groups with no relators
#H
#H  Revision 3.31  1995/03/21  16:51:13  sam
#H  fixed 'FpGroupOps.\=' (suggested by Derek Holt)
#H
#H  Revision 3.30  1995/02/22  08:12:05  sam
#H  fixed 'IsPerfect' for f.p. groups
#H  (suggested by Derek Holt)
#H
#H  Revision 3.29  1995/01/18  09:47:31  sam
#H  allowed list of names as only argument of 'FreeGroup'
#H
#H  Revision 3.28  1994/10/25  08:58:05  htheisse
#H  introduced the use of 'OperationsRecord'
#H
#H  Revision 3.27  1994/10/10  08:34:35  fceller
#H  fixed 'CosetTableFpGroup' from crashing while processing 'IdWord'
#H
#H  Revision 3.26  1994/08/23  10:51:37  mschoene
#H  fixed 'LISFG' to include the generators of <H>
#H
#H  Revision 3.25  1994/08/22  11:07:16  vfelsch
#H  added a forgotten fi;
#H
#H  Revision 3.24  1994/08/22  09:45:53  vfelsch
