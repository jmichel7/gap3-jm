...
**
*H  @(#)$Id: selfile.c,v 1.1.1.1 1996/12/11 12:40:09 werner Exp $
**
...
static int (*SFfunc) P(( String, String*, struct stat* )) = 0;
...
static void SFtextChanged P(( void ));
...
Boolean XsraSelFile ( toplevel, prompt, init_path, show_entry, name_return )
    ...
    String		prompt;
    String		init_path;
    Int			(*show_entry) P(( String, String*, struct stat* ));
    String *		name_return;
{
    XEvent		event;
