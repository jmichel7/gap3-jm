...
**
*H  @(#)$Id: gaptext.c,v 1.1.1.1 1996/12/11 12:40:08 werner Exp $
**
...
static void GapTextInsertSelection P(( Widget, XEvent*, String*, Cardinal* ));
static void GetSelection P(( Widget, Time, String*, Cardinal ));
static void DoSelection P(( Widget, XtPointer, Atom*, Atom*, XtPointer,
			    UInt*, Int* ));

static void GapTextInsertSelection ( w, evt, parms, nums )
    Widget              w;
    XEvent            * evt;
    String            * parms;
    Cardinal          * nums;
...
static void DoSelection( w, cd, selection, type, value, length, format )
    Widget              w;
    XtPointer           cd;
    Atom              * selection;
    Atom              * type;
...
static void GetSelection( w, time, parms, nums )
    Widget 	    w;
    Time 	    time;
    String        * parms;
    Cardinal 	    nums;
...
*/
static void GapTextInsertChar P(( Widget, XEvent*, String*, Cardinal* ));

static void GapTextInsertChar ( w, evt, parms, nums )
    Widget              w;
    XEvent            * evt;
    String            * parms;
    Cardinal          * nums;
...
*/
static void GapTextSelectStart P(( Widget, XEvent*, String*, Cardinal* ));

static void GapTextSelectStart ( w, evt, parms, nums )
    Widget              w;
    XEvent            * evt;
    String            * parms;
    Cardinal          * nums;
...
*/
static void GapTextExtendAdjust P(( Widget, XEvent*, String*, Cardinal* ));

static void GapTextExtendAdjust ( w, evt, parms, nums )
    Widget              w;
    XEvent            * evt;
    String            * parms;
    Cardinal          * nums;
...
*/
static void GapTextExtendEnd P(( Widget, XEvent*, String*, Cardinal* ));

static void GapTextExtendEnd ( w, evt, parms, nums )
    Widget              w;
    XEvent            * evt;
    String            * parms;
    Cardinal          * nums;
...
*/
static void GapTextInitialize P(( Widget, Widget, ArgList, Cardinal* ));

static void GapTextInitialize ( request, new, args, nums )
    Widget	    request;
    Widget          new;
    ArgList         args;
    Cardinal      * nums;
...
*/
static void GapTextDestroy P(( Widget ));

static void GapTextDestroy(w)
    Widget 	    w;
{
    GapTextWidget   gap = (GapTextWidget) w;
...
*/
static void GapSrcInitialize P(( Widget, Widget, ArgList, Cardinal* ));

static void GapSrcInitialize ( request, new, args, nums )
    Widget          request;
    Widget          new;
    ArgList         args;
    Cardinal      * nums;
...
*/
static void GapSrcDestroy P(( Widget ));

static void GapSrcDestroy (w)
    Widget          w;
{
...
*/
static XawTextPosition GapSrcReadText P(( Widget, XawTextPosition,
                                          XawTextBlock*, unsigned long ));

static XawTextPosition GapSrcReadText ( w, pos, text, length )
    Widget              w;
    XawTextPosition     pos;
    XawTextBlock      * text;
...
*/
static int GapSrcReplaceText P(( Widget, XawTextPosition, XawTextPosition,
			         XawTextBlock* ));

static int GapSrcReplaceText ( w, start, end, text )
    Widget 	        w;
...
*/
static XawTextPosition GapSrcScan P(( Widget, XawTextPosition,
				      XawTextScanType, XawTextScanDirection,
				      int, int ));

static XawTextPosition GapSrcScan ( w, pos, type, dir, cnt, ind )
    Widget                  w;
    XawTextPosition         pos;
