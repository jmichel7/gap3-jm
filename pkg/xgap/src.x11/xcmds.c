...
**
*H  @(#)$Id: xcmds.c,v 1.1.1.1 1996/12/11 12:40:10 werner Exp $
**
...
*H
*H  Revision 1.10  1995/08/08  12:25:20  fceller
*H  fixed a bug in returning the result of canceled file name query
*H
*H  Revision 1.9  1995/07/24  09:28:30  fceller
*H  reworked most parts to use nice typedefs
*H
*H  Revision 1.7  1993/12/23  08:48:22  fceller
*H  fixed a string length bug, used unsigned bitmaps
*H
...
static Boolean AnswerGap P(( String, Long, Long, Long, Long ));

static Boolean AnswerGap ( format, a1, a2, a3, a4 )
    String       format;
    Long         a1;
    Long         a2;
    Long         a3;
...
*/
static Boolean ParseInt P(( String*, Int* ));

static Boolean ParseInt ( buf, val )
    String    * buf;
    Int       * val;
{
    Int         mult;
...
*/
static Boolean ParseString P(( String*, String*, Int* ));

static Boolean ParseString ( buf, str, len )
     String	  * buf;
     String       * str;
     Int          * len;
{
...
Boolean GapWindowCmd P(( String, Int ));

Boolean GapWindowCmd ( cstr,  len )
    String              cstr;
    Int                 len;
{
    Boolean             ret;
...
*/
static void ButtonSelected P(( Widget, XtPointer, XtPointer ));
...
static void TextSelected P(( Widget, XtPointer, XtPointer ));
...
static void NotifyClick P(( Widget, XEvent*, String*, Cardinal* ));
...
static Boolean FunOpenSelector P(( TypeArg* ));

static Boolean FunOpenSelector ( arg )
    TypeArg           * arg;
{
    Int                 i;
    Int                 n;
...
*/
static Boolean FunCloseSelector P(( TypeArg* ));

static Boolean FunCloseSelector ( arg )
    TypeArg   * arg;
{
    Int         i;
...
*/
static Boolean FunChangeList P(( TypeArg* ));

static Boolean FunChangeList ( arg )
    TypeArg       * arg;
{
    Int             i;
    String          ptr;
...
*/
static Boolean FunEnableButton P(( TypeArg* ));

static Boolean FunEnableButton ( arg )
    TypeArg   * arg;
{
    Int         i;
    Widget      entry;
...
*/
static Boolean FunUnhighlihtSelector P(( TypeArg* ));

static Boolean FunUnhighlihtSelector ( arg )
    TypeArg   * arg;
{
    /* give debug info */
...
static void PaneChosen P(( Widget, XtPointer, XtPointer ));
...
static void PopingDown P(( Widget, XtPointer, XtPointer ));
...
static Boolean FunPopupShell P(( TypeArg* ));

static Boolean FunPopupShell ( arg )
    TypeArg       * arg;
{
    Int             i;
    String          ptr;
...
*/
static Boolean FunShowPopup P(( TypeArg* ));

static Boolean FunShowPopup ( arg )
    TypeArg       * arg;
{
    Dimension       w1,  h1,  bw;
    Int        	    x,  y,  x2,  y2;
...
*/
static Boolean FunShowDialog P(( TypeArg* ));

static Boolean FunShowDialog ( arg )
    TypeArg       * arg;
{
    Int             first;
    Int             res;
...
*/
static void CloseWindow P(( TypeGapWindow* ));
...
*/
static void MouseClickWindow P(( Widget, XtPointer, XEvent*, Boolean* ));

static void MouseClickWindow ( talk, cd, evt, ctd )
    Widget 	    talk;
    XtPointer       cd;
    XEvent        * evt;
    Boolean       * ctd;
...
static void WmDeleteWindow P(( Widget, XEvent*, String*, Cardinal* ));

static void WmDeleteWindow ( w, event, pars, n )
    Widget 	    w;
    XEvent        * event;
    String        * pars;
    Cardinal      * n;
...
*/
static Widget CreateTitleWindow P(( Widget ));

static Widget CreateTitleWindow ( paned )
    Widget	    paned;
{
...
static Boolean FunOpenWindow P(( TypeArg* ));

static Boolean FunOpenWindow ( arg )
    TypeArg       * arg;
{
    Int             h = arg->iargs[1];
    Int             w = arg->iargs[0];
...
*/
static Boolean FunCloseWindow P(( TypeArg* ));

static Boolean FunCloseWindow ( arg )
    TypeArg   * arg;
{
    /* give debug info */
...
*/
static Boolean FunAddTitle P(( TypeArg* ));

static Boolean FunAddTitle ( arg )
    TypeArg   * arg;
{
...
*/
static Boolean FunColorModel P(( TypeArg* ));

static Boolean FunColorModel ( arg )
    TypeArg   * arg;
{
...
*/
static Boolean FunFastUpdate P(( TypeArg* ));

static Boolean FunFastUpdate ( arg )
    TypeArg *	arg;
{
    Boolean	flag;
...
*/
static Boolean FunFontInfo P(( TypeArg* ));

static Boolean FunFontInfo ( arg )
    TypeArg	* arg;
{
...
*/
static Boolean FunQueryPointer P(( TypeArg* ));

static Boolean FunQueryPointer ( arg )
    TypeArg       * arg;
{
    Int        	    x,  y,  x2,  y2;
    UInt            bt;
...
*/
static Boolean FunResize P(( TypeArg* ));

static Boolean FunResize ( arg )
    TypeArg * 		arg;
{
...
*/
static void MenuClick P(( Widget, XtPointer, XtPointer ));
...
static Boolean FunMenu P(( TypeArg* ));

static Boolean FunMenu ( arg )
    TypeArg       * arg;
{
    Int             i;
    String          ptr;
...
*/
static Boolean FunDeleteMenu P(( TypeArg* ));

static Boolean FunDeleteMenu ( arg )
    TypeArg   * arg;
{
    TypeMenu  * menu;
    Int         j;
...
*/
static Boolean FunCheckMenuEntry P(( TypeArg* ));

static Boolean FunCheckMenuEntry ( arg )
    TypeArg   * arg;
{
    TypeMenu  * menu;
    Widget      entry;
...
*/
static Boolean FunEnableMenuEntry P(( TypeArg* ));

static Boolean FunEnableMenuEntry ( arg )
    TypeArg   * arg;
{
    TypeMenu  * menu;
    Widget      entry;
...
*/
static Boolean FunClearAll P(( TypeArg* ));

static Boolean FunClearAll ( arg )
    TypeArg   * arg;
{
...
*/
static Boolean FunRemoveObjects P(( TypeArg* ));

static Boolean FunRemoveObjects ( arg )
    TypeArg     * arg;
{
    String	  str;
    Int           n;
...
*/
static Boolean FunSetLineWidth P(( TypeArg* ));

static Boolean FunSetLineWidth ( arg )
    TypeArg   * arg;
{
...
*/
static Boolean FunSetColor P(( TypeArg* ));

static Boolean FunSetColor ( arg )
    TypeArg   * arg;
{
    if ( arg->iargs[1] < 0 )
...
*/
static Boolean FunDrawBox P(( TypeArg* ));

static Boolean FunDrawBox ( arg )
    TypeArg               * arg;
{
...
*/
static Boolean FunDrawCircle P(( TypeArg* ));

static Boolean FunDrawCircle ( arg )
    TypeArg               * arg;
{
    TypeGapGraphicObject  * obj;
    Int 	            n;
...
*/
static Boolean FunDrawDisc P(( TypeArg* ));

static Boolean FunDrawDisc ( arg )
    TypeArg               * arg;
{
    TypeGapGraphicObject  * obj;
    Int 	            n;
...
*/
static Boolean FunDrawLine P(( TypeArg* ));

static Boolean FunDrawLine ( arg )
    TypeArg               * arg;
{
    TypeGapGraphicObject  * obj;
    Int 	            n;
...
*/
static Boolean FunDrawRectangle P(( TypeArg* ));

static Boolean FunDrawRectangle ( arg )
    TypeArg               * arg;
{
    TypeGapGraphicObject  * obj;
    Int 	            n;
...
*/
static Boolean FunDrawText P(( TypeArg* ));

static Boolean FunDrawText ( arg )
    TypeArg               * arg;
{
    TypeGapGraphicObject  * obj;
    XFontStruct           * font = arg->font;
