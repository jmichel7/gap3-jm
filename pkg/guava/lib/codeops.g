...
LinCodeOps.AutomorphismGroup := function (C)
    ...
    ExecPkg("leon","bin/wtdist", Concatenation("-q ",incode,"::code ",
            String(MinimumDistance(Ccalc))," ",inV,"::code"),".");
    ExecPkg("leon","bin/desauto", Concatenation("-code -q ",
...
LinCodeOps.CodeIsomorphism := function (C1, C2)
    ...
    ExecPkg("leon","bin/wtdist", Concatenation("-q ",code1,"::code ",
            String(MinimumDistance(C1))," ",cwcode1,"::code"),".");
    ExecPkg("leon","bin/wtdist", Concatenation("-q ",code2,"::code ",
            String(MinimumDistance(C2))," ",cwcode2,"::code"),".");
    ExecPkg("leon","bin/desauto", Concatenation("-iso -code -q ",
            code1,"::code ",code2,"::code ",cwcode1,"::code ",
            cwcode2,"::code ",output),".");
    ExecPkg("guava","bin/leonconv",Concatenation("-e ",output," ", 
            infile),".");
    Read(infile);
...
CodeOps.IsEquivalent := function (C1, C2 )
    return CodeIsomorphism( C1, C2 )<>false;
end;
