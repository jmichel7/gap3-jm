...
FILE *ip,*op;
extern int readbaselo (int nb, int *base, int *lorb);
extern int orbitsv (int pt, int *sv, int lo);
extern int readpsv (int e, int nb, int nperms, int **svptr);
extern int addsv (int pt, int *sv);
extern int image (int pt);
/* Many of the variables are as in program tcrun */

int coinc(c1,c2)  int c1,c2;
