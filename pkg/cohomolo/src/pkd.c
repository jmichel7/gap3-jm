...
*/
char inf[80],outf[80],temp[80],temp2[80],mspace[SPACE],*vec[MV],**mat[MM],
...
{ char arg,err,c;
  ...
  strcpy(inf,argv[arg]); strcat(inf,"."); strcpy(temp,inf); strcat(temp,"temp");
  strcpy(temp2,temp); strcat(temp2,"2");
