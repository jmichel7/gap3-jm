...
extern char inf0[],inf1[],inf4[],outf0[],outf1[],outf2[],outcopy[],
             act,ch1,norm;
extern short  intexp,facexp,stage,mcl,marg,
...
extern int rsp,ptrsp,rspk;
extern long inf3offset,inf4offset;
short *wf,*wc,**inteno,intcpd,inng,*nsd1,*nsd2,intfe,**npcb2;
extern FILE *ip,*ipm,*op;
FILE *ipcopy,*opcopy;
extern int prnrel();extern int ingp(char inp);extern int outgp();

void enter(g,pow)  short *g,pow;
...
int entvec(h,g,pow) short *h,*g,pow;
...
void expand(short *p1,short *p2,short len)
...
void compress(p1,p2,len)  short *p1,*p2,len;
...
/* We have a new generator for H^2. This is put into echelon form with the
   exisiting generators, and stored.
*/
