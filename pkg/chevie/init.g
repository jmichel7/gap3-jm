...
AUTO(ReadChv("lib/sperm"),
  IsSignedPerm, Perm, SignedMatStab, SignedPermListList, SignedPerm, 
  SignedPermMatMat, Signs);
...
AUTO(ReadChv("prg/gt"),
  ClassTypes,RationalUnipotentClasses,ClosedSubsystems,ClosedSubsystemsPoset,
  ClosedSubsystemsRepresentatives);
