...
CHEVIE.AutoLoad(["PrintDiagram","BraidRelations","CharName","ReflectionName",
  ...
  "FactorizedSchurElement","SchurElement","GetParams","Embed","HeckeCharTable",
  "Rep","HeckeRepresentation","Representation","UnipotentCharacters",
  "Invariants","Discriminant"],["G4_22"],"tbl/cmp4_22");
CHEVIE.AutoLoad(["NrConjugacyClasses","ClassInfo","CharInfo","CharTable"],
  ["2G5","G4_22"],"tbl/cmp4_22");
CHEVIE.AutoLoad(["phi","PhiFactors"],["2G5"],"tbl/cmp4_22");
CHEVIE.AutoLoad(["PrintDiagram","GeneratingRoots","GeneratingCoRoots",
  ...
  "Size","ReflectionDegrees","NrConjugacyClasses","ParabolicRepresentatives",
...
CHEVIE.AutoLoad(["PrintDiagram","GeneratingRoots",
  ...
  "Representation","Invariants","Discriminant","UnipotentCharacters"],["G32"],
  "tbl/cmplxg32");
...
CHEVIE.AutoLoad(["PrintDiagram","BraidRelations","GeneratingRoots",
  ...
  "CycPolSchurElements","Irr","CharTable","HeckeCharTable",
  "HeckeRepresentation","Representation","sparseFakeDegrees",
  "UnipotentCharacters","Invariants"],["G34"],"tbl/cmplxg34");
...
CHEVIE.AutoLoad(["CartanMat","PrintDiagram","ReflectionName","SemisimpleRank",
  ...
  "ParameterToSymbol","UnipotentCharacters"],["I"],"tbl/coxi");
...
CHEVIE.AutoLoad(["DecompositionMatrix"],["F4","G2","G25","G26","I"],
  "tbl/exceptio");
...
CHEVIE.AutoLoad(["CartanMat","ReflectionDegrees","PrintDiagram",
  ...
  "NrConjugacyClasses","FundamentalGroup","CenterSimplyConnected",
  "ClassParameter","CharParams","LowestPowerFakeDegree",
  "HighestPowerFakeDegree","CharName","CharInfo","CharTable","Hk",
...
CHEVIE.AutoLoad(["CartanMat","PrintDiagram","ReflectionName","GeneratingRoots",
  ...
  "FundamentalGroup","CenterSimplyConnected","WordClass","ClassInfo",
  "ClassParameter","CharParams","CharName","LowestPowerFakeDegree","CharInfo",
...
CHEVIE.AutoLoad(["CartanMat","Size","PrintDiagram","GeneratingRoots",
  "FundamentalGroup","CenterSimplyConnected","ParabolicRepresentatives",
  "WordsClassRepresentatives","ClassInfo","NrConjugacyClasses","CharInfo",
  "CharName","gensMODA","ClassParameter","CharTable","Hk","HeckeCharTable",
  "FactorizedSchurElement","HeckeRepresentation","Representation",
  "PoincarePolynomial","symbolcharparam","Invariants","CycPolGenericDegree",
  "SchurElement","FakeDegree","UnipotentCharacters","ReflectionDegrees",
  "UnipotentClasses"],["D"],"tbl/weyld");
CHEVIE.AutoLoad(["ReflectionDegrees","GeneratingRoots","FundamentalGroup",
  "CenterSimplyConnected","NrConjugacyClasses","WordsClassRepresentatives",
  "ClassNames","ClassInfo","ParabolicRepresentatives","CharInfo",
  "cyclestructure","generators","CartanMat","PowerMaps",
  ...
  "Representation","DecompositionMatrix","UnipotentCharacters","Invariants",
  "UnipotentClasses","KLeftCellRepresentatives"],["E6"],"tbl/weyle6");
CHEVIE.AutoLoad(["ReflectionDegrees","Size","GeneratingRoots",
  "FundamentalGroup","CenterSimplyConnected","NrConjugacyClasses",
  "WordsClassRepresentatives","ClassNames","ClassInfo",
...
CHEVIE.AutoLoad(["CartanMat","PrintDiagram","ReflectionName","GeneratingRoots",
  "HyperplaneRepresentatives","ParabolicRepresentatives","FundamentalGroup",
  "CenterSimplyConnected","Size","ReflectionDegrees","NrConjugacyClasses",
  "ClassInfo","CharInfo","cyclestructure","generators","orbits","PowerMaps",
  "sparseFakeDegrees","ClassParameter","HeckeCharTable","PoincarePolynomial",
  "SchurModels","SchurData","Representation","WGraphs","WGraph",
  "HeckeRepresentation","UnipotentCharacters","Invariants","Discriminant",
  "UnipotentClasses","KLeftCellRepresentatives"],["F4"],"tbl/weylf4");
CHEVIE.AutoLoad(["CartanMat","PrintDiagram","ReflectionName",
  "ParabolicRepresentatives","GeneratingRoots","HyperplaneRepresentatives",
  "FundamentalGroup","CenterSimplyConnected","Size","ReflectionDegrees",
  "NrConjugacyClasses","CharInfo","WordsClassRepresentatives","ClassNames",
  "ClassInfo","PowerMaps","sparseFakeDegrees","generators","ClassParameter",
  "HeckeCharTable","HeckeRepresentation","Representation","PoincarePolynomial",
  "SchurElements","SchurModels","SchurData","SchurElement",
  "UnipotentCharacters","Invariants","Discriminant","UnipotentClasses",
  "KLeftCellRepresentatives"],["G2"],"tbl/weylg2");
