...
CHEVIE.AutoLoad(["PrintDiagram"],["AffineA","AffineB","AffineD","AffineE6",
  ...
  "prg/affine");
CHEVIE.AutoLoad(["PrintDiagram","BraidRelations","ReflectionName",
...
CHEVIE.AutoLoad(["PrintDiagram","SemisimpleRank","BraidRelations","Size",
  ...
  "PowerMaps","CharParams","CharInfo","LowestPowerFakeDegrees",
  "HighestPowerFakeDegrees","CharSymbols","FakeDegree","SchurModel",
  "SchurData","SchurElement","FactorizedSchurElement","HeckeCharTable",
...
CHEVIE.AutoLoad(["PhiFactors","ReducedInRightCoset","ClassInfo",
  "NrConjugacyClasses","CharInfo","CharTable","UnipotentCharacters"],["timp"],
  "tbl/cmpxtimp");
CHEVIE.AutoLoad(["ReflectionName","NrConjugacyClasses",
  "WordsClassRepresentatives","ClassInfo","PhiFactors","ClassParameter",
  "CharInfo","FakeDegree","HeckeCharTable","CharTable","Representation",
  "HeckeRepresentation","UnipotentCharacters","Ennola"],["2I"],"tbl/cox2i");
CHEVIE.AutoLoad(["ReflectionDegrees","Size","GeneratingRoots","InvariantModel",
  ...
  "tbl/coxh3");
CHEVIE.AutoLoad(["ReflectionDegrees","Size","GeneratingRoots","InvariantModel",
  "CartanMat","words","WordsClassRepresentatives","NrConjugacyClasses",
  "ParabolicRepresentatives","ClassParameter","PowerMaps","ClassInfo",
  "CharInfo","vpolheckeirreducibles","CycPolSchurElements","cycpolfakedegrees",
  "HeckeCharTable","WGraphs","WGraph","HeckeRepresentation","Representation",
  "UnipotentCharacters","Discriminant","KLeftCellRepresentatives"],["H4"],
  "tbl/coxh4");
CHEVIE.AutoLoad(["CartanMat","PrintDiagram","ReflectionName","SemisimpleRank",
  ...
  "ReflectionDegrees","NrConjugacyClasses","ParabolicRepresentatives",
  "CharInfo","WordsClassRepresentatives","ClassInfo","HeckeCharTable",
  "Representation","HeckeRepresentation","Frobenius","PoincarePolynomial",
  "SchurElement","FakeDegree","CharTable","DecompositionMatrix",
  "FactorizedSchurElement","Invariants","SymbolToParameter",
  "ParameterToSymbol","UnipotentCharacters","Ennola"],["I"],"tbl/coxi");
...
CHEVIE.AutoLoad(["WordsClassRepresentatives","ClassInfo","NrConjugacyClasses",
  "ClassParameter","CharParams","CharInfo","CharTable","HeckeCharTable",
  "PhiFactors","HeckeRepresentation","Representation","FakeDegree",
  "UnipotentCharacters","UnipotentClasses"],["2A"],"tbl/weyl2a");
CHEVIE.AutoLoad(["ClassParams","WordsClassRepresentatives","ClassInfo",
  "NrConjugacyClasses","ClassParameter","IsPreferred","CharParams","CharInfo",
  "CharTable","HeckeCharTable","HeckeRepresentation","Representation",
  "FakeDegree","PhiFactors","UnipotentCharacters","Ennola","UnipotentClasses"],
  ["2D"],"tbl/weyl2d");
CHEVIE.AutoLoad(["NrConjugacyClasses","ClassInfo","CharInfo","cyclestructure",
  ...
  "ClassParameter","HeckeCharTable","HeckeRepresentation","Representation",
  "PhiFactors","UnipotentCharacters","Ennola","UnipotentClasses"],["2E6"],
  "tbl/weyl2e6");
CHEVIE.AutoLoad(["NrConjugacyClasses","ClassInfo","CharInfo","cyclestructure",
...
CHEVIE.AutoLoad(["cyclestructure","generators","phi","CartanMat",
...
CHEVIE.AutoLoad(["CartanMat","ReflectionDegrees","PrintDiagram",
  ...
  "LowestPowerFakeDegree","HighestPowerFakeDegree","CharInfo","CharTable","Hk",
...
CHEVIE.AutoLoad(["CartanMat","PrintDiagram","ReflectionName","GeneratingRoots",
  ...
  "LowestPowerFakeDegree","CharInfo","CharTable","Hk","HeckeCharTable",
  "PoincarePolynomial","SchurElement","FactorizedSchurElement",
  "HeckeRepresentation","Representation","FakeDegree","DecompositionMatrix",
  "UnipotentCharacters","Ennola","UnipotentClasses","Invariants"],["B"],
  "tbl/weylbc");
CHEVIE.AutoLoad(["CartanMat","Size","PrintDiagram","GeneratingRoots",
  "WeightInfo","ParabolicRepresentatives","WordsClassRepresentatives",
  "ClassInfo","NrConjugacyClasses","CharInfo","gensMODA","ClassParameter",
  "CharTable","Hk","HeckeCharTable","FactorizedSchurElement",
