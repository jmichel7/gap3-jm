...
void interactive_pga ( Logical group_present, FILE_TYPE StartFile, int
group_nmr, int ***auts, struct pga_vars *pga, struct pcp_vars *pcp)
{
   ...
   do {
	 ...
	 stabiliser_option (option, auts, perms, a, b, c, orbit_length, 
			    pga, pcp);
	 /*
	   free_space (pga->soluble || pga->combined, perms, orbit_length,
	   a, b, c, pga);
	   */
	 break;
...
void stabiliser_option(int option,int***auts,int **perms,int *a, int *b, char *c, int *orbit_length,
