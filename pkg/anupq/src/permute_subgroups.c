...
int**permute_subgroups(FILE_TYPE LINK_input,int**a,int**b,char**c,int***auts,
...
void compute_images(int**A,int K,int depth,/* number of available positions */
int *permutation,struct pga_vars *pga)
{
...
void find_available_positions(int K,int**A,int**Image,int**row,int**column,
