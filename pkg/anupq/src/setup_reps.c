...
void setup_reps ( int *reps, int nmr_of_reps, int *orbit_length, int **perms, int *a, 
int *b, char *c, int ***auts, FILE_TYPE descendant_file, FILE_TYPE
covers_file, struct pga_vars *pga, struct pcp_vars *pcp)
{ 
