...
void save_auts (FILE_TYPE ofp, int *head, int *list, struct pcp_vars *pcp)
{
   register int alpha;
   register int offset;
...
int restore_auts ( FILE_TYPE ifp, int offset, int nmr_saved, int retain, int
*new_index, int *head, int *list)
{
...
void restore_automorphisms (FILE_TYPE ifp, int **head, int **list, struct pcp_vars *pcp)
{
   int new_index = 0;
   int offset;
   register int alpha;
