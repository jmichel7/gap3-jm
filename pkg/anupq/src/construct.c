...
Logical select_group ( int *min_step, int *max_step, int order_bound,
...
int construct ( int call_depth, struct pga_vars *flag, int option, FILE_TYPE output_file,
FILE_TYPE start_file, int k, int order_bound, int group_nmr, struct pga_vars
*pga,  struct pcp_vars *pcp)
{
   int ***auts;
   char *name;
   register int step;
...
void report(int nmr_of_capables, int nmr_of_descendants, int nmr_of_covers, struct pga_vars *pga,
struct pcp_vars *pcp)
{
#include "define_y.h"
